    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            institutions.forEach((institution) => {
                ...
                ('input[name=categories]:checked')).map(function (input) { return input.value })

                const isChosenCategory = selectedCategories.every(category => foundationCategories.includes(category))
                if (isChosenCategory === false) {
                    institution.parentElement.parentElement.style.display = "none"
                }
                console.log({foundationCategories, selectedCategories, isChosenCategory})
            });
